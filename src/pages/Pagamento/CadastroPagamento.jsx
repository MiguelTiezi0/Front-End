...
export function CadastroPagamento() {
  ...
  const handleSubmit = async (e) => {
    ...
    const pagamentoBody = {
      ...
      VendaId: vendasEmAberto.length > 0 ? vendasEmAberto[0].id : null, // pega a venda mais antiga em aberto
      TotalPago: Number(pagamento.totalPago),
      Desconto: 0,
      FormaDePagamento: [pagamento.formaDePagamento], // sempre array!
    ...
    <div className="centroCadastroPagamento">
      <div className="CadastroPagamento">
        ...
        <form className="cadastroPagamentoForm" onSubmit={handleSubmit}>
          ...
          <div>
            <button className="btnPagar" type="submit" disabled={!pagamento.clienteId || totalDevido === 0}>
              Pagar
            </button>
          </div>
        </form>
